...
(define-fun-rec isTriangleRec ((a Int) (trianglenum Int) (n Int)) Bool
  (ite (= a trianglenum)
    true
    (ite (< a trianglenum) 
      false
      (isTriangleRec a (+ trianglenum n)(+ n 1))))
)

(define-fun isTriangle ((a Int)) Bool
    (isTriangleRec a 0 1))


(declare-fun n () Int)
(assert (or (= n 12)(= n 8)(= n 13) (= n 17) (= n 15) (= n 21) (= n 9)(= n 10)(= n 18)(= n 14)(= n 16)(= n 6)(= n 78)(= n 153)(= n 276)(= n 55)))
