...
(constraint (and (not (fp.isNaN AminusBK00))(< AminusBK00 inputs_upperr)(> AminusBK00 inputs_lowerr)))
(constraint (and (not (fp.isNaN AminusBK01))(< AminusBK01 inputs_upperr)(> AminusBK01 inputs_lowerr)))
(constraint (and (not (fp.isNaN AminusBK10))(< AminusBK10 inputs_upperr)(> AminusBK10 inputs_lowerr)))
(constraint (and (not (fp.isNaN AminusBK11))(< AminusBK11 inputs_upperr)(> AminusBK11 inputs_lowerr)))
