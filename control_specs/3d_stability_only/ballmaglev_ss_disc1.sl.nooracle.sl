...
; NINPUTS 1 
; NINPUTS 1 
(define-fun A00r () Real  32.885363484714 )
(define-fun A01r () Real 0.785250799098 )
(define-fun A02r () Real (- 0.333111544119) )
(define-fun A10r () Real 1375.926178951143 )
(define-fun A11r () Real 32.885363484714 )
(define-fun A12r () Real (- 14.006197592478) )
(define-fun A20r () Real 0.000000000000 )
(define-fun A21r () Real 0.000000000000 )
(define-fun A22r () Real 0.021776517320 )
(define-fun B0r () Real (- 0.014416162550) )
(define-fun B1r () Real (- 0.640599123306) )
(define-fun B2r () Real 0.049156958929 )
; SMT 2
...
(define-fun A00 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven A00r))
(define-fun A01 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven A01r))
(define-fun A02 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven A02r))
(define-fun A10 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven A10r))
(define-fun A11 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven A11r))
(define-fun A12 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven A12r))
(define-fun A20 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven A20r))
(define-fun A21 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven A21r))
(define-fun A22 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven A22r))
(define-fun B0 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven B0r))
(define-fun B1 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven B1r))
(define-fun B2 () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven B2r))

(define-fun upper () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven upperr))
(define-fun lower () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven lowerr))
(define-fun init_upper () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven init_upperr))
(define-fun init_lower () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven init_lowerr))
(define-fun inputupper () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven 10.0))
(define-fun inputlower () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven (- 10.0)))
...
(define-fun four () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven 4.0))
(define-fun two () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven 2.0))
(define-fun one () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven 1.0))
(define-fun zero () (_ FloatingPoint 11 53) ((_ to_fp 5 11) roundNearestTiesToEven 0.0))
