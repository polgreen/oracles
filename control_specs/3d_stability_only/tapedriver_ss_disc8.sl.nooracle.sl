...
; NINPUTS 1 
; NINPUTS 1 
(define-fun A00r () Real  (- 0.044640969136) )
(define-fun A01r () Real (- 0.015949525614) )
(define-fun A02r () Real 0.000744504031 )
(define-fun A10r () Real 0.031250000000 )
(define-fun A11r () Real 0.000000000000 )
(define-fun A12r () Real 0.000000000000 )
(define-fun A20r () Real 0.000000000000 )
(define-fun A21r () Real 0.000976562500 )
