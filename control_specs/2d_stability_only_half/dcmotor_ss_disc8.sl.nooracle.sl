...
(define-fun four () (_ FloatingPoint 11 53) ((_ to_fp 11 53) roundNearestTiesToEven 4.0))
(define-fun two () (_ FloatingPoint 11 53) ((_ to_fp 11 53) roundNearestTiesToEven 2.0))
(define-fun one () (_ FloatingPoint 11 53) ((_ to_fp 11 53) roundNearestTiesToEven 1.0))
